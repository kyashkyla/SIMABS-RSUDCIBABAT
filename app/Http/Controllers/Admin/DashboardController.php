...
class DashboardController extends Controller
{
    ...
    public function index()
    {
        ...
        $attendanceToday = Attendance::whereDate('attendance_date', $today)->get();
        ...
        for ($i = 5; $i >= 0; $i--) {
            ...
            $rows = Attendance::whereDate('attendance_date', $date)->get();
        ...
        $latestAttendance = Attendance::with('employee')
            ...
            ->map(function (Attendance $a) {
                return [
                    ...
                    'jam' => $a->check_in_at ? $a->check_in_at->format('H:i') : '-',
                    'metode' => match ($a->check_in_method) {
                        'face' => 'Face ID',
                        'otp' => 'OTP',
